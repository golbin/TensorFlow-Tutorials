...
- [02 - Variable](./01 - TensorFlow Basic/02 - Variable.py)
  - 텐서플로우의 플레이스홀더와 변수의 개념을 익힙니다.
- [03 - Linear Regression](./01 - TensorFlow Basic/03 - Linear Regression.py)
...
- [03 - Word2Vec](./02 - Neural Network Basic/03 - Word2Vec.py)
  - 자연어 분석에 매우 중요하게 사용되는 Word2Vec 모델을 간단하게 구현해봅니다.

### [03 - TensorBoard, Saver](./03 - TensorBoard, Saver)

- [01 - Saver](./03 - TensorBoard, Saver/01 - Saver.py)
  - 학습시킨 모델을 저장하고 재사용하는 방법을 배워봅니다.
- [02 - TensorBoard](./03 - TensorBoard, Saver/02 - TensorBoard.py)
  - 텐서보드를 이용해 신경망의 구성과 손실값의 변화를 시각적으로 확인해봅니다.
- [03 - TensorBoard #2](./03 - TensorBoard, Saver/03 - TensorBoard2.py)
  - 텐서보드에 히스토그램을 추가해봅니다.

### [04 - MNIST](./04 - MNIST)

- [01 - MNIST](./04 - MNIST/01 - MNIST.py)
  - 머신러닝 학습의 Hello World 와 같은 MNIST(손글씨 숫자 인식) 문제를 신경망으로 풀어봅니다.
- [02 - Dropout](./04 - MNIST/02 - Dropout.py)
  - 과적합 방지를 위해 많이 사용되는 Dropout 기법을 사용해봅니다.

### [05 - CNN](./05 - CNN)

- [01 - CNN](./05 - CNN/01 - CNN.py)
  - 이미지 처리 분야에서 가장 유명한 신경망 모델인 CNN 을 이용하여 더 높은 인식률을 만들어봅니다.
- [02 - tf.layers](./05 - CNN/02 - tf.layers.py)
  - 신경망 구성을 손쉽게 해 주는 High level API 인 layers 를 사용해봅니다.

### [06 - Autoencoder, GAN](./06 - Autoencoder)

- [01 - Autoencoder](./06 - Autoencoder/01 - Autoencoder.py)
  - 대표적인 비감독(Unsupervised) 학습 방법인 Autoencoder 를 사용해봅니다.

### [07 - GAN](./07 - GAN)

- [01 - GAN](./07 - GAN/01 - GAN.py)
  - 2016년에 가장 관심을 많이 받았던 비감독 학습 방법인 GAN 을 구현해봅니다.
- [02 - GAN #2](./07 - GAN/02 - GAN2.py)
  - GAN 을 응용하여 원하는 숫자의 손글씨 이미지를 생성하는 모델을 만들어봅니다. 이런 방식으로 흑백 사진을 컬러로 만든다든가, 또는 선화를 채색한다든가 하는 응용이 가능합니다.

### [08 - RNN](./08 - RNN)

- [01 - Counting](./08 - RNN/01 - MNIST.py)
  - 자연어 처리나 음성 처리 분야에 많이 사용되는 RNN 의 기본적인 사용법을 익힙니다.
- [02 - Counting](./08 - RNN/02 - Counting.py)
  - 순서가 있는 데이터에 강한 RNN 특징을 이용해 숫자를 순서대로 세는 모델을 구현해봅니다.
- [03 - Seq2Seq](./08 - RNN/03 - Seq2Seq.py)
  - 챗봇, 번역, 이미지 캡셔닝등에 사용되는 시퀀스 학습/생성 모델인 Seq2Seq 을 구현해봅니다.
- [Chatbot](./08 - RNN/ChatBot)
  - Seq2Seq 모델을 이용해 간단한 챗봇을 만들어봅니다.

### [09 - Inception](./05 - Inception)
...
자세한 내용은 [09 - Inception/README.md](./09 - Inception/README.md) 문서를 참고 해 주세요.
...
자세한 내용은 [10 - DQN/README.md](./10 - DQN/README.md) 문서를 참고 해 주세요.
